...
Where to park and how to avoid tickets.
...
## Details
- **Primary parking:** Driveway spots are first choice. If another car is present, stagger so both vehicles can exit without moving the other.
- **Street rules:** Obey any posted time limits and sweeping days; tickets are the guest’s responsibility.
- **Shared areas:** Do not block sidewalks, alleys, or neighboring driveways. Keep a clear path for trash pickup.
- **EV charging:** Not available on-site; nearest public chargers are in central Boulder. Bring your own adapter if you plan to use public stations.
- **Snow/ice:** In winter, check around tires before driving off; we keep a shovel and ice melt by the porch.

## FAQs
- **Can oversized vehicles fit?** Standard SUVs/minivans fit in the driveway. For trucks/vans, use street parking where legal.
